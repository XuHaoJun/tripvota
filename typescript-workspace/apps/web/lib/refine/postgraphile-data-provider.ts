...
export function createPostGraphileDataProvider(
  ...
  return {
    ...
    create: async <TData extends BaseRecord = BaseRecord, TVariables = {}>(
      ...
      throw new Error(
        'Create operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    createMany: async <TData extends BaseRecord = BaseRecord, TVariables = {}>(
      ...
      throw new Error(
        'CreateMany operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    update: async <TData extends BaseRecord = BaseRecord, TVariables = {}>(
      ...
      throw new Error(
        'Update operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    updateMany: async <TData extends BaseRecord = BaseRecord, TVariables = {}>(
      ...
      throw new Error(
        'UpdateMany operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    deleteOne: async <TData extends BaseRecord = BaseRecord, TVariables = {}>(
      ...
      throw new Error(
        'DeleteOne operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    deleteMany: async <TData extends BaseRecord = BaseRecord>(
      ...
      throw new Error(
        'DeleteMany operation is not supported via GraphQL. Use ConnectRPC instead.'
      );
    },
    getApiUrl: () => {
      return endpoint;
