  ...
  return (
    <>
      <div
        ...
        className={`group relative flex w-64 flex-col rounded-lg border border-border bg-card p-4 shadow-sm transition-all hover:shadow-md touch-none ${
      ...
      >
        {/* Drag Handle */}
        {mode === 'arrangement' && (
          <div className="absolute left-2 top-2 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100">
        ...
        <div className="mt-2 flex-1">
          <h3 className="mb-2 text-sm font-semibold text-card-foreground">{item.title}</h3>
